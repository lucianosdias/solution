...
(async () => {
  const {
    t: ticket = "",
    o: baseKbPath = `C:\\Projetos\\Genexus\\Models\\Develop`,
    d: destKbPath = `C:\\Projetos\\Genexus\\Models\\KBPoc2022_1.1`,
    a: action = actions.import,
  } = argv;
  ...
  try {
    ...
    //     const commitsFile = "./commit_list_poc2022_develop.xml";
